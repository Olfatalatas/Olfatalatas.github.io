                    ...
                    <div class="booking-form">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            if (isset($_POST['send'])) {
                                ...
                                $sql1 = "UPDATE pemesanan SET selesai='$selesai', bukti='$bukti' WHERE id_pemesanan='$id'";
                                mysqli_query($koneksi, $sql1);
                                $cek = mysqli_affected_rows($koneksi);
                                if ($cek > 0) {
                                    echo "<script>alert('Data tersimpan');</script>";
                                    echo "<script>location='jobmu.php';</script>";
                                } else {
                            ...
                            <div class="form-btn">
                                <button class="submit-btn" name="send">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
