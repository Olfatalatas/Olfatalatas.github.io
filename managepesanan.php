            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)">Manage Order</a>
                    </div>
                        ...
                        <div class="col-md-10">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    ...
                                    <p class="card-category">Manage an Order</p>
                                </div>
                                <?php
                                $id = $_GET['id'];
                                $data = $koneksi->query("SELECT * FROM pembayaran WHERE id_pemesanan='$id'");
                                $d = $data->fetch_assoc();
                                ?>
                                <div class="card-body">
                                    <form action="prosesmanage.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jasa" class="form-control" value="<?php echo $d['jasa']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bayar" class="form-control" value="<?php echo $d['bayar']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary pull-right" name="send">Submit</button>
