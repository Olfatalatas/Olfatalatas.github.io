    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <ul class="nav nav-tabs">
                <li><a href="detailpesanan.php?id=<?php echo $d['id_pemesanan']; ?>">Order</a></li>
                <li class="active"><a href="detailpembayaran.php">Payment</a></li>
            </ul>
                ...
                <div class="tab-pane active" id="home">
                    ...
                    <table class="table">
                        <div class="form-group">
                            <div class="col-xs-6">
                                <th>Opsi :</th>
                                <td class="col-sm-8"><?php echo $d["opsi"]; ?></td>
                            </div>
                        </div>
                    </table>
                </div>
