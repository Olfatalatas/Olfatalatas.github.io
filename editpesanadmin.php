                        ...
                        <div class="col-md-10">
                            <div class="card">
                                <div class="card-header card-header-success">
                                    ...
                                    <p class="card-category">Update Order</p>
                                </div>
                                <?php
                                $id = $_GET['id'];
                                ...
                                ?>
                                <div class="card-body">
                                    <form action="proseseditpesan.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="tujuan" class="form-control" value="<?php echo $d['tujuan']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating"></label>
                                                    <input type="time" name="waktu" class="form-control" value="<?php echo $d['waktu']; ?>">
                                                </div>
                                            </div>
                                        </div>
