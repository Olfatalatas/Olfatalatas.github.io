            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:void(0)">Update Bio Admin</a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="prosesupdateadmin.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Jobs</label>
                                                    <input type="text" name="tingkat" class="form-control" value="<?php echo $d['tingkat']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="bahasa" class="form-control" value="<?php echo $d['bahasa']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="about" class="form-control" value="<?php echo $d['about']; ?>">
                                                </div>
                                            </div>
                                        </div>
