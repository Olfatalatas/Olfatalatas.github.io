			...
			<div class="table-wrapper">
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						$data = mysqli_query($koneksi, "SELECT * FROM pemesanan WHERE acc='Pending'");
						while ($d = mysqli_fetch_array($data)) {
						?>

							<?php if ($d["email_pemesan"] == $email) : ?>
							<?php else : ?>
								<tr>
									...
									<td>
										...
										<?php endif ?>
										<a href="../detailpesanan.php?id=<?php echo $d['id_pemesanan']; ?>"> Details </a> |
										<a href="../penerimaan.php?nama=<?php echo $d['nama']; ?> & jasa=<?php echo $d['jasa']; ?> & bayar=<?php echo $d['bayar']; ?> & id=<?php echo $d['id_pemesanan']; ?> "> Accept? </a>
									</td>
								</tr>
							<?php endif; ?>
						<?php
