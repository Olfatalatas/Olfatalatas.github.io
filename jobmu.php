                        ...
                        ?>
                            ...
                            <?php else : ?>
                                <tr>
                                    ...
                                    <td><a>Diterima Oleh</a> <?php echo $d['acc']; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php endif ?>
                                        <a href="selesaiworker.php?nama=<?php echo $d['nama']; ?> & jasa=<?php echo $d['jasa']; ?> & bayar=<?php echo $d['bayar']; ?> & id=<?php echo $d['id_pemesanan']; ?> "> Done? </a>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        <?php
